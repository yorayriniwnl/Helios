...
echo "Training anomaly-detection model on seeded data..."
$VENV_PY ml-engine/training/train.py || echo "Warning: model training failed; anomaly detection will use its rule-based fallback."
