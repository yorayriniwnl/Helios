...
Write-Host "Training anomaly-detection model on seeded data..."
& $venvPython ml-engine/training/train.py
if ($LASTEXITCODE -ne 0) {
    Write-Host "Warning: model training failed; anomaly detection will use its rule-based fallback."
}
